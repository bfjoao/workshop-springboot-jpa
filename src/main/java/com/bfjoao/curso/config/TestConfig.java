...
import com.bfjoao.curso.entidades.Payment;
import com.bfjoao.curso.entidades.Product;
import com.bfjoao.curso.entidades.User;
import com.bfjoao.curso.entidades.enums.OrderStatus;
import com.bfjoao.curso.repositories.CategoryRepository;
import com.bfjoao.curso.repositories.OrderItemRepository;
import com.bfjoao.curso.repositories.OrderRepository;
import com.bfjoao.curso.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner { //  permite executar um código automaticamente assim que a aplicação Spring Boot for iniciada.
	...
	public void run(String... args) throws Exception {
		Category cat1 = new Category(null, "Eletrocnics");
